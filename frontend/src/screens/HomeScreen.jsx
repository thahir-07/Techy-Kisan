...
const HomeScreen = () => {
  ...
  const content = " Techy Kisan is a web application that helps the farmer and businessman to interact with each other without any mediator.\n This system will help the farmer to get the actual price for his inputs (crops)."
  ...
  return (
    <div className="App pl-40 h-[70vh] pr-40 w-full flex-col justify-center items-center flex" >
      ...
      <div className="flex mt-10  gap-3 w-full">
          ...
          <span className='text-green-600  font-semibold'>{" Techy Kisan"}</span></p>
